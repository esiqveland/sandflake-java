package com.github.esiqveland.sandflake.encoding;
...
public abstract class BaseEncoding {
    ...
    public static BaseEncoding base32Sandflake() {
        return BASE32_SANDFLAKE;
    }

    private static final BaseEncoding BASE32_SANDFLAKE =
            new StandardBaseEncoding("base32sandflake()", "0123456789ABCDEFGHJKMNPQRSTVWXYZ", '=');
